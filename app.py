...
def km_stats_tab(tab):
    with tab:
        ...
        try:
            kfA.plot(ax=ax, ci_show=True, show_censors=True, censor_styles={"marker":"|","ms":8,"markersize":8})
            kfB.plot(ax=ax, ci_show=True, show_censors=True, censor_styles={"marker":"|","ms":8,"markersize":8})
        except Exception:
            kfA.plot(ax=ax, ci_show=True); kfB.plot(ax=ax, ci_show=True)
