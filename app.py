...
def cohorts_tab(tab):
    with tab:
        ...
        with left:
            st.markdown('<div class="panel panel-a">', unsafe_allow_html=True); A = build_cohort_ui("A"); st.markdown('</div>', unsafe_allow_html=True)
        with right:
            st.markdown('<div class="panel panel-b">', unsafe_allow_html=True); B = build_cohort_ui("B"); st.markdown('</div>', unsafe_allow_html=True)
