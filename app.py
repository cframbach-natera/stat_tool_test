# app.py
# QS Oncology Stats – Cohort Builder v5.2.1
# Neutral theme, include/exclude quick filters, green "Build" button, all relationships via rules.
...
def render_quick_filters(prefix: str, dfp: pd.DataFrame) -> (str, Dict):
...
def add_condition(prefix: str):
    default_cond = {
        ...
        "anchor_type": "AnchorExists",
        "anchor_exists_target": "first_treatment_date",
        "anchor_exists_should": True,
